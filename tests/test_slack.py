...
@pytest.mark.parametrize("test_profile, expected", [
    ({"display_name_normalized": "pybob", "real_name_normalized": "Bob"}, "pybob"),
    ({"display_name_normalized": None, "real_name_normalized": "Julian Sequeira"}, "Julian Sequeira")
])
...
def test_get_available_username_wrong_format():
    with pytest.raises(ValueError) as e:
        get_available_username({"display_name_normalized": None, "real_name_normalized": None})
...
@pytest.mark.parametrize(
    "test_id, expected",
    [("ABC123", "<@ABC123>"), ("EFG123", "<@EFG123>"), ("<@XYZ123>", "<@XYZ123>"), ("<@ABC123>", "<@ABC123>")]
)
...
@pytest.mark.parametrize(
    "test_id, expected",
    [("<@ABC123>", "ABC123"), ("<@EFG123>", "EFG123"), ("XYZ123", "XYZ123"), ("ABC123", "ABC123"), ("ABC<>@123", "ABC<>@123")]
)
